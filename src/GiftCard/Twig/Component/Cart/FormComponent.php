...
namespace App\GiftCard\Twig\Component\Cart;

use Doctrine\Persistence\ObjectManager;
use Sylius\Bundle\ShopBundle\Twig\Component\Cart\FormComponent as BaseFormComponent;
...
final class FormComponent extends BaseFormComponent
{
    ...
    #[LiveAction]
    public function removeGiftCardCode(): void
    {
        $this->formValues['giftCardCode'] = '';
